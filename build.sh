...
# Deivce Tree
git clone --depth=1 https://github.com/PocoF4Trees/device_xiaomi_munch -b LunarisAOSP-T device/xiaomi/munch
...
# Kernel Tree
#git clone --depth=1 https://github.com/Olzhas-Kdyr/kernel_xiaomi_sm8250 kernel/xiaomi/munch
