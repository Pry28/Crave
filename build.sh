...
# Deivce Trees
git clone https://github.com/Olzhas-Kdyr/android_device_xiaomi_munch -b infinity device/xiaomi/munch
git clone https://github.com/Olzhas-Kdyr/android_device_xiaomi_sm8250-common -b infinity device/xiaomi/sm8250-common
